...
1. **Selenium** to scrape baseball history data.
2. **Pandas** for data cleaning and transformation.
3. **SQLite** for storage and querying.
4. **Streamlit** for dashboard creation.
...
- Cleans and transforms data into structured CSV format
- Imports CSVs into SQLite with proper data types
- Supports command-line SQL querying with filters and joins
